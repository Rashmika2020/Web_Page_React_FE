  ...
  return (
    <div className="sidebar">
      ...
      <ul>
        ...
        <li className={activeItem === 'Favorites' ? 'active' : ''} onClick={() => setActiveItem('Favorites')}>
          <img src="assets/sidebar/Heart.png" alt="Favorites" /> Favorites
        </li>
        <li className={activeItem === 'Your Library' ? 'active' : ''} onClick={() => setActiveItem('Your Library')}>
        ...
        <li className={activeItem === 'Log out' ? 'active' : ''} onClick={() => setActiveItem('Log out')}>
